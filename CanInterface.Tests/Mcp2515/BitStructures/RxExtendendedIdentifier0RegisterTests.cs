...
namespace CanInterface.Test.MCP2515.BitStructures
{
    ...
    public class RxExtendendedIdentifier0RegisterTests
    {
        public static IEnumerable<TestCaseData> ByteConstructorTestSource
        {
            get
            {
                yield return new TestCaseData((byte)0b0000_0000, (byte)0)
                    .SetName("RxExtendendedIdentifier0Register - Byte Constructor - 0");
                yield return new TestCaseData((byte)0b1111_1111, (byte)255)
                    .SetName("RxExtendendedIdentifier0Register - Byte Constructor - 255");
            }
        }
        ...
        {
            var register = new RxExtendendedIdentifier0Register(value);
        ...
        public static IEnumerable<TestCaseData> ToByteTestSource
        {
            ...
            {
                yield return new TestCaseData((byte)0b0000_0000, (byte)0)
                    .SetName("RxExtendendedIdentifier0Register - ToByte - 0");
                yield return new TestCaseData((byte)0b1111_1111, (byte)255)
                    .SetName("RxExtendendedIdentifier0Register - ToByte - 255");
            }
        }
        ...
        {
            var register = new RxExtendendedIdentifier0Register(eid);
